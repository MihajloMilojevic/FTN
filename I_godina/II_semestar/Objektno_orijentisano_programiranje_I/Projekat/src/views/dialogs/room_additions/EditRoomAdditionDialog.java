package views.dialogs.room_additions;
...
public class EditRoomAdditionDialog extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public EditRoomAdditionDialog(String value) {
		this.value = value;
		setTitle("Edit Room Addition");
		setResizable(false);
		setModal(true);
		setIconImage(new ImageIcon("./assets/icons/room_additions.png").getImage());
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(e -> {
					if (valueTf.getText().trim().isBlank()) {
						JOptionPane.showMessageDialog(this, "Room addition's name cannot be empty.", "Error", JOptionPane.ERROR_MESSAGE);
						return;
					}
					ok = true;
