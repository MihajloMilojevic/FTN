...
OUTP01=$(cat <<EOL
Unesite string: Ovo. je. prvi. primer.
Rezultujuci string: Ovo. Je. Prvi. Primer.
EOL
)
...
OUTP02=$(cat <<EOL
Unesite string: drugi. !123priMER.
Rezultujuci string: drugi. !123PriMER.
EOL
)

TEST03=$(cat <<EOL
Tr. EcI. PRImER. 123123
EOL
)

OUTP03=$(cat <<EOL
Unesite string: Tr. EcI. PRImER. 123123
Rezultujuci string: Tr. ECI. PRIMER. 123123
EOL
)
...
OUTP04=$(cat <<EOL
Unesite string: aAAA. BbBB. CcCC.
Rezultujuci string: aAAA. BBBB. CCCC.
EOL
)
...
OUTP05=$(cat <<EOL
Unesite string: asd FGH jKl
Rezultujuci string: asd FGH jKl
EOL
)
