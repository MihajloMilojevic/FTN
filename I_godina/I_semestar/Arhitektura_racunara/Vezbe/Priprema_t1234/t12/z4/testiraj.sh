...
OUTP03=$(cat <<EOL
Unesite string: ar9 ar9 ar9 ar9
EOL
)

TEST04=$(cat <<EOL
7ostatak8nula7 123123123
EOL
)

OUTP04=$(cat <<EOL
Unesite string: 7ostatak8nula7 123123123
EOL
)
...
OUTP05=$(cat <<EOL
Unesite string: 1a3b5c7d9e
EOL
)

TEST06=$(cat <<EOL
123prekoracenje456 321321321
EOL
)

OUTP06=$(cat <<EOL
Unesite string: 123prekoracenje456 321321321
EOL
)
