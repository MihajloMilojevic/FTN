...
TEST01=$(cat <<EOL
Petar je 26.12. dobio 36 poena iz AR
EOL
)

OUTP01=$(cat <<EOL
Unesite string: Petar je 26.12. dobio 36 poena iz AR
EOL
)
...
OUTP04=$(cat <<EOL
Unesite string: 123\$ABC #@  abc zxg\$#@
EOL
)
