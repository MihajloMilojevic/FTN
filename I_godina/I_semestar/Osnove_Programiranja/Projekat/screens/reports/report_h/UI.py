...
def setupUi( frame):
    ...
    description_label.setText("Ukupan broj i ukupna cena prodatih karata po prodavcima u poslednjih 30 dana")
    ...
    item = QtWidgets.QTableWidgetItem("Ukupna cena karata")
