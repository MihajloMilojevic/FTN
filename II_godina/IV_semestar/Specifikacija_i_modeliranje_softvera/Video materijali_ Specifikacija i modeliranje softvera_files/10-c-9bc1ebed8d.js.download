(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[10],{QAft:function(t,e,r){"use strict"
...
return{arrowSize:"0.5rem",arrowBorderWidth:r.widthSmall,arrowBackgroundColor:e.white,arrowBorderColor:e.tiara,arrowBackgroundColorInverse:e.licorice,arrowBorderColorInverse:"transparent"}}var K,v,q,w
...
r.ownerDocument!==document&&e.push(r.ownerDocument.defaultView)}return e}function v(t){var e=[]
if(!_["a"])return e
var r=Object(u["a"])(t)
if(r){var n=r
...
"static"===o.position&&a||e.push(n)}e.push(Object(b["a"])(r).body)}return e}var q=r("gpCx")
var w=r("k72m")
...
r+=o.scrollLeft-i.scrollLeft}return{top:e,left:r}}},{key:"positionedParentsOffset",get:function(){var t=v(this.node)
...
"window"===d?this.constrainTo(Object(q["a"])(e)):"scroll-parent"===d?this.constrainTo(K(this.target.node)[0]):"parent"===d?this.constrainTo(this.container):"function"===typeof d?this.constrainTo(Object(u["a"])(d.call(null))):"object"===typeof d&&this.constrainTo(Object(u["a"])(d))}Object(o["a"])(t,[{key:"overflow",value:function(t){var e=Object(q["a"])(t)
var r=Object(g["a"])(t)
var n=Object(g["a"])(e)
...
return{top:e-n.top,left:r-n.left}}},{key:"placement",get:function(){return S(this.element.placement)}},{key:"minWidth",get:function(){return this.element.shouldStretchVertically?this.target.width:null}},{key:"minHeight",get:function(){return this.element.shouldStretchHorizontally?this.target.height:null}},{key:"position",get:function(){var t=Object(q["a"])(this.target.node)
...
n.forEach((function(t){return t.cancel()}))}}}var U=r("BTe1")
var X=r("MObU")
var Q=r.n(X)
var Z=r("0mOT")
var G=r("eGSd")
...
var vt=(mt=Object(R["a"])("8.0.0",{trackPosition:"shouldTrackPosition",over:"shouldPositionOverTarget"}),ft=Object(J["a"])(),pt=Object(F["j"])(et,_t),mt(ut=ft(ut=pt(ut=(bt=gt=function(t){Object(a["a"])(r,t)
var e=Object(d["a"])(r)
function r(t){var o
Object(i["a"])(this,r)
o=e.call(this,t)
...
o._id=o.props.id||Object(U["a"])("Position")
...
var jt=r("jtGx")
var yt=r("TjLr")
var kt=function(t){Object(a["a"])(r,t)
var e=Object(d["a"])(r)
function r(){var t
Object(i["a"])(this,r)
...
this._raf.push(Object(Y["a"])((function(){setTimeout((function(){t._focusRegion=yt["a"].activateRegion(t.contentElement,Object(n["a"])({},r))}),0)})))}},{key:"close",value:function(){this._focusRegion&&yt["a"].blurRegion(this.contentElement,this._focusRegion.id)}},{key:"focus",value:function(){if(!this.props.open||!this.contentElement)return
this._focusRegion&&yt["a"].focusRegion(this.contentElement,this._focusRegion.id)}},{key:"blur",value:function(){if(!this.props.open||!this.contentElement)return
this.close()}},{key:"render",value:function(){var t=Object(Ot["a"])(r,this.props)
var e=this.props.role||(this.props.label?"dialog":void 0)
return this.props.open?c.a.createElement(t,Object.assign({},Object(jt["a"])(this.props,r.propTypes),{ref:this.getRef,role:e,"aria-label":this.props.label,className:this.props.className}),this.props.children):null}},{key:"contentElement",get:function(){var t=Object(u["a"])(this.props.contentElement)
t||(t=Object(u["a"])(this._root))
return t}},{key:"focused",get:function(){return this.contentElement&&this._focusRegion&&yt["a"].isFocused(this.contentElement,this._focusRegion.id)}}])
r.displayName="Dialog"
return r}(s["Component"])
kt.propTypes={children:h.a.node,as:h.a.elementType,display:h.a.oneOf(["auto","block","inline-block"]),label:h.a.string,open:h.a.bool,onBlur:h.a.func,onDismiss:h.a.func,defaultFocusElement:h.a.oneOfType([h.a.element,h.a.func]),contentElement:h.a.oneOfType([h.a.element,h.a.func]),liveRegion:h.a.oneOfType([h.a.arrayOf(h.a.element),h.a.element,h.a.func]),shouldContainFocus:h.a.oneOfType([h.a.bool,h.a.oneOf(["keyboard","screenreader"])]),shouldReturnFocus:h.a.bool,shouldCloseOnDocumentClick:h.a.bool,shouldCloseOnEscape:h.a.bool,shouldFocusOnOpen:h.a.bool}
kt.defaultProps={children:null,display:void 0,label:void 0,open:false,shouldFocusOnOpen:true,shouldContainFocus:false,shouldReturnFocus:false,shouldCloseOnDocumentClick:true,shouldCloseOnEscape:true,defaultFocusElement:null,contentElement:null,liveRegion:null,onBlur:function(t){},onDismiss:function(t){}}
var Ct=r("FOOe")
var Tt=r("K7t/")
var Pt=r("EgqM")
function Bt(t,e){var r=e.currentTarget
var n=e.relatedTarget||e.nativeEvent.toElement
n&&(n===r||Object(Pt["a"])(r,n))||t(e)}var St=r("HMVb")
var zt=r("9yTY")
var Mt=r("lxKu")
var At,Ft,Wt,Rt,Dt,xt,Lt,It,Ht,Vt,Yt,Nt,Ut,Xt,Qt,Zt
var Gt=(At=Object(R["a"])("8.0.0",null,"Use Popover's `renderTrigger` prop instead."),Ft=Object(J["a"])(),At(Wt=Ft(Wt=(Dt=Rt=function(t){Object(a["a"])(r,t)
var e=Object(d["a"])(r)
function r(){Object(i["a"])(this,r)
return e.apply(this,arguments)}return r}(I),Rt.displayName="PopoverTrigger",Dt))||Wt)||Wt)
var Jt=(xt=Object(R["a"])("8.0.0",null,"Use Popover's `children` instead."),Lt=Object(J["a"])(),xt(It=Lt(It=(Vt=Ht=function(t){Object(a["a"])(r,t)
var e=Object(d["a"])(r)
function r(){Object(i["a"])(this,r)
return e.apply(this,arguments)}return r}(I),Ht.displayName="PopoverContent",Vt))||It)||It)
var $t=(Yt=Object(R["a"])("8.0.0",{show:"isShowingContent",defaultShow:"defaultIsShowingContent",variant:"color",label:"screenReaderLabel",trackPosition:"shouldTrackPosition",alignArrow:"shouldAlignArrow",onShow:"onShowContent",onDismiss:"onHideContent",onToggle:"onShowContent/onHideContent"}),Nt=Object(J["a"])(),Ut=Object(Ct["a"])(),Yt(Xt=Nt(Xt=Ut(Xt=(Zt=Qt=function(t){Object(a["a"])(r,t)
var e=Object(d["a"])(r)
function r(t){var o
Object(i["a"])(this,r)
o=e.call(this,t)
...
o.hide(t)}}
o.handleTriggerBlur=function(t){o.props.on.indexOf("focus")>-1&&o._raf.push(Object(Y["a"])((function(){Object(Tt["a"])(o._view)||o.hide(t)})))}
...
o._id=o.props.id||Object(U["a"])("Popover")
o._raf=[]
o._handleMouseOver=Bt.bind(null,(function(t){o.show(t)}))
o._handleMouseOut=Bt.bind(null,(function(t){o.hide(t)}))
return o}Object(o["a"])(r,[{key:"componentDidMount",value:function(){if(this.isTooltip){this._focusRegion=new Mt["a"](this._contentElement,{shouldCloseOnEscape:false,shouldCloseOnDocumentClick:true,onDismiss:this.hide})
...
var s=2*(Object(St["a"])(a)+Object(St["a"])(d))
...
if(this.props.withArrow){o=qt["a"]
